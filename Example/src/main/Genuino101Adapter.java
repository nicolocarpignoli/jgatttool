...
public class Genuino101Adapter {
	...
	public void init(String mac) throws InterruptedException{
		...
		conn.getCharacteristics().add(new BLECharacteristic<Integer> ("arange", "manage",0,int.class,"19b10021-e8f2-537e-4f6c-d104768a1214", "", true, true, false)); // aran
		...
		conn.getCharacteristics().add(new BLECharacteristic<Integer> ("calib", "manage",0,int.class,"9b100123-e8f2-537e-4f6c-d104768a1214", "", true, true, false)); // calib
		*/
	}
