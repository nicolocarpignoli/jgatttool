...
public class Genuino101Adapter {
	...
	public void init(String mac) throws InterruptedException {
		...
		conn.getCharacteristics().add(new BLECharacteristic<Long>("stepcount", "data", 0, long.class,
				"19b10011-e8f2-537e-4f6c-d104768a1214", "", true, false, false)); // stepcount
		conn.getCharacteristics().add(new BLECharacteristic<Float>("ax", "data", 0f, float.class,
				"19b10012-e8f2-537e-4f6c-d104768a1214", "", true, false, true)); // ax
		conn.getCharacteristics().add(new BLECharacteristic<Float>("ay", "data", 0f, float.class,
				"19b10013-e8f2-537e-4f6c-d104768a1214", "", true, false, true)); // ay
		conn.getCharacteristics().add(new BLECharacteristic<Float>("az", "data", 0f, float.class,
				"19b10014-e8f2-537e-4f6c-d104768a1214", "", true, false, true)); // az
		conn.getCharacteristics().add(new BLECharacteristic<Float>("gx", "data", 0f, float.class,
				"19b10015-e8f2-537e-4f6c-d104768a1214", "", true, false, true)); // gx
		conn.getCharacteristics().add(new BLECharacteristic<Float>("gy", "data", 0f, float.class,
				"19b10016-e8f2-537e-4f6c-d104768a1214", "", true, false, true)); // gy
		conn.getCharacteristics().add(new BLECharacteristic<Float>("gz", "data", 0f, float.class,
				"19b10017-e8f2-537e-4f6c-d104768a1214", "", true, false, true)); // gz
		conn.getCharacteristics().add(new BLECharacteristic<Integer>("shock", "data", 0, int.class,
				"19b10018-e8f2-537e-4f6c-d104768a1214", "", true, false, true)); // shock
		conn.getCharacteristics().add(new BLECharacteristic<Integer>("mode", "manage", 0, int.class,
				"19b10019-e8f2-537e-4f6c-d104768a1214", "", true, true, false)); // mode
		conn.getCharacteristics().add(new BLECharacteristic<Integer>("srange", "manage", 0, int.class,
				"19b10020-e8f2-537e-4f6c-d104768a1214", "", true, true, false)); // sran
		conn.getCharacteristics().add(new BLECharacteristic<Integer>("arange", "manage", 0, int.class,
				"19b10021-e8f2-537e-4f6c-d104768a1214", "", true, true, false)); // arange
		conn.getCharacteristics().add(new BLECharacteristic<Integer>("grange", "manage", 0, int.class,
				"9b100122-e8f2-537e-4f6c-d104768a1214", "", true, true, false)); // gran
		// CalibCharacteristic deleted: authCharacteristics added
		conn.getCharacteristics().add(new BLECharacteristic<Long>("auth", "data", 0, long.class,
				"9B100124-E8F2-537E-4F6C-D104768A1214", "", true, true, false));
